...
public class Sort {
     ...
     */
    public static void maxHeap(double[] array, int unSortedLength) {
     ...
     * @param unSortedLength is the length of unsorted array part
     */
    public static void minHeap(double[] array, int unSortedLength) {
        for (int i = unSortedLength - 1; i >= 0; i--) {
            if(hasChild(array, i, unSortedLength)) {
    ...
    public static boolean hasChild(double[] array, int index, int unSeqLength) {
        return hasLeftChild(array, index, unSeqLength);
    }

    public static boolean hasLeftChild(double[] array, int index) {
    ...
    public static boolean hasLeftChild(double[] array, int index, int unSeqLength) {
    ...
    public static boolean hasRightChild(double[] array, int index, int unSeqLength) {
     ...
     * @return
     */
    public static void divideMergeArray(double[] array, int left, int right) {
        if(left < right) {
     ...
     * @return
     */
    public static void mergeTwoArrays(double[] array, int left, int mid, int right) {
    ...
    public static void quickSortArray(double[] array, int left, int right) {
        if(left < right) {
    ...
    public static int adjustArray(double[] array, int left, int right) {
